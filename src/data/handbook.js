...
export const HANDBOOK = [
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      { type: "p", text: "Follow the chain of command when you need help, want to raise a concern, or are submitting a request. Start with the lowest rank that can actually deal with it, and give them the chance to before you go over their head." },
      { type: "p", text: "In practice that means **Supervisory**, then **Management**, then the **Directors**. All three are there to answer questions, take requests and sort problems out, and one of them is your first port of call for almost everything. Work upward from there only when you need to." },
      { type: "p", text: "Do not go straight to the Founders with something a rank below them can handle. The chain is not ceremony: it exists so that things are dealt with quickly and by the people whose job it is to deal with them, and skipping it usually makes an issue slower rather than faster." },
      { type: "p", text: "If the appropriate rank cannot resolve it, or it genuinely needs someone higher, escalate it up the chain. It reaches the Foundership Team that way, which is the route that gets it looked at properly." },
      { type: "note", title: "Internal Affairs is not a rung on this ladder", body: "A complaint about a staff member goes to Internal Affairs through a **Staff Complaint** ticket, whatever rank the person you are reporting holds. That is not skipping the chain: IA is a separate oversight line that exists precisely so a complaint does not have to travel through the people it might be about. Everything else follows the chain above. See *Tickets* and *Internal Affairs*." },
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      { type: "table", head: ["Tier", "Ranks", "Can log", "Also gets"], rows: [
        ...
        ["**Internal Affairs**", "Trial Internal Affairs to IA Supervisor", "Nothing. The punishment log is read-only for IA", "Internal Affairs page, and strikes, demotions and terminations that bypass hierarchy, by IA rank"],
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      { type: "p", text: "Claim a ticket before you work it, so two people are not answering the same person. Claiming narrows the channel to you, the opener, and Management and Directors, who stay in on every type for oversight. Everybody else the ticket was open to drops out: on a Staff Complaint that is the rest of Internal Affairs, on a Fast Pass the rest of Supervisory, on ordinary tickets the rest of the support pool. Ban Appeals and IA Applications keep their whole review team, because those are decided together." },
      { type: "note", title: "A claimed ticket is yours", body: "Once you claim one, nobody else can claim it, close it or send a close request on it, and the rest of your tier can no longer see it. A Director can override. Management and Directors keep reading it throughout, on every ticket type, which is oversight rather than a claim: seeing a ticket and being able to act on one are different things, and a claimed ticket still answers to whoever claimed it. Transferring one means unclaiming it and letting somebody else claim, which puts it back in front of the tier." },
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      { type: "p", text: "Internal Affairs sits outside both routes. An IA rank that holds demotion applies it directly from the Internal Affairs page, with no approval step, and no IA rank promotes anybody at all. See Internal Affairs for which rank holds what." },
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      { type: "p", text: "Internal Affairs investigates the staff team, which is why it sits outside it." },
      { type: "note", variant: "hard", title: "IA and the staff team are separate", body: "You cannot be a moderator and a member of Internal Affairs at the same time. Internal Affairs has to stay separate from the staff team for investigations to be impartial, and IA carries no in-game moderation powers of its own. Joining IA from a staff rank means leaving that rank behind." },
      { type: "h3", text: "What IA does" },
      { type: "list", items: [
        "Handle and review Staff Complaint tickets.",
        "Investigate complaints and reports of staff misconduct.",
        "Conduct fair and impartial investigations into staff members.",
        "Review evidence: reports, screenshots and recordings.",
        "Interview staff members and anyone else involved.",
      ...
      { type: "list", items: [
        ...
        "**Leave of absence**, with /loa or from the Dashboard, the same as anybody else. Being exempt from the duty quota is not the same as being unable to take time off: an LOA is how you tell the team you are away, and yours goes to Management like everyone else's.",
      ]},
      ...
      { type: "h3", text: "Applying to Internal Affairs" },
      { type: "p", text: "Open an **Internal Affairs Application** ticket. You will be asked which IA rank you are applying for, any previous staff or moderation experience, why you want to join, why you would be a good fit, and how much time you can give each week. Experience is optional; the explanation is not." },
      { type: "p", text: "The four IA ranks, lowest first, are Trial Internal Affairs, Internal Affairs, Internal Affairs Officer and Internal Affairs Supervisor." },
      { type: "list", items: [
        "Applications are read by **Management and Directors only**. Internal Affairs cannot see applications to their own team.",
        "Current staff can apply. Your rank is shown to the reviewers automatically, and being accepted means leaving the staff team.",
        "A serving IA member applying for a higher IA rank keeps their place; the exclusivity rule is about the staff ladder, not about IA itself.",
      ]},
    ],
  },
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      { type: "table", head: ["Page", "Who sees it", "What it holds"], rows: [
        ...
        ["**Internal Affairs**", "Internal Affairs only", "Issue a strike, demote, terminate. Only the ones your IA rank holds are shown, and promotion is not among them at any rank"],
        ...
        ["**In-Game Permissions**", "Management and above", "Status, per-person checks, revoke everyone. Not in the sidebar; reach it at /permissions"],
        ...
        ["**Changelog**", "Everyone", "What changed and when. Not in the sidebar; reach it at /changelog"],
      ]},
  ...
  // ------------------------------------------------------------------
  {
    ...
    blocks: [
      ...
      { type: "table", head: ["Command", "Minimum rank", "What it does"], rows: [
        ...
        ["/loa", "Staff Team and Internal Affairs", "File a leave of absence"],
